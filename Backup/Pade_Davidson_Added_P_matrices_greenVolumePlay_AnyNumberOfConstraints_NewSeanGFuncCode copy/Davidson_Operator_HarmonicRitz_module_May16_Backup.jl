...
function jacDavRitzHarm_basic(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,alpha,
	innerLoopDim::Integer,dims::Integer,tol_MGS::Float64,tol_conv::Float64,
		tol_eigval::Float64, tol_bicgstab::Float64)::Tuple{Float64, Int32}
	...
	for itr in 2 : innerLoopDim  # Need to determine when this for loops stops 
		...
		srcBasis[:, itr] = bad_bicgstab_matrix(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,
				P,alpha, theta, hRitzTrg, hRitzSrc, prjCoeff, resVec,tol_bicgstab)
...
function jacDavRitzHarm_basic_for_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,alpha,
	innerLoopDim::Integer,dims::Integer,tol_MGS::Float64,tol_conv::Float64,
...
# 	vecDim::Integer, repDim::Integer, innerLoopDim::Integer,tol_MGS::Float64,tol_conv::Float64)::Float64
	...
	previous_eigval = theta
	nb_it_vals_basic_for_restart = 0
	nb_it_eigval_conv = 0
...
function jacDavRitzHarm_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,
	...
	tol_MGS::Float64,tol_conv::Float64,tol_eigval::Float64, tol_bicgstab::Float64)::Tuple{Float64, Int32} # ::Float64
	...
	for it in 1:restartDim # Need to think this over 
		...
		if it == 1
			theta,srcBasis,trgBasis,kMat,resVec,hRitzSrc,hRitzTrg,eigenvalues,eigenvectors,nb_it_basic_for_restart=
				jacDavRitzHarm_basic_for_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,alpha,
		...
		gramSchmidtHarm!(restart_trgBasis, restart_srcBasis, bCoeffs1, bCoeffs2, gMemSlfN,
					gMemSlfA,cellsA,chi_inv_coeff,P,alpha,restartDim, tol_MGS)
