...
fct_call_restart = jacDavRitzHarm_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,
	P,alpha,innerLoopDim,restartDim,dims,tol_MGS,tol_conv,tol_eigval,tol_bicgstab)
...
"""
If we want to test different bicgstab tolerances 
"""
# restartDim = 18
# dims = Int(cellsA[1]*cellsA[2]*cellsA[3]*3)
# innerLoopDim = Int(dims-dims/2)
# tol_MGS = 1.0e-12
# tol_conv = 1.0e-6
# tol_eigval = 1.0e-9
...
# 			jacDavRitzHarm_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,
# 				P,alpha,innerLoopDim,restartDim,dims,tol_MGS,tol_conv,tol_eigval,tol_bicgstab_vals[index])
...
# savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing bicgstab tolerance/tol_bicgstab_basic_vs_nb_it.png")
...
# xlabel!("Bicgstab tolerance values")
# ylabel!("Number of iterations")
# savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing bicgstab tolerance/tol_bicgstab_restart_vs_nb_it.png")
...
# # savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing bicgstab tolerance/tol_bicgstab_basic_vs_eigvals_relative_diff.png")
...
# # xlabel!("Bicgstab tolerance values")
# # ylabel!("Number of iterations")
# # savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing bicgstab tolerance/tol_bicgstab_restart_vs_eigvals_relative_diff.png")


solver_method = "bicgstab"
# solver_method = "direct"
"""
If we want to test different restart sizes and see how the amount of 
iterations to converge changes 
"""
# restartDim = 18
dims = Int(cellsA[1]*cellsA[2]*cellsA[3]*3)
innerLoopDim = Int(dims-dims/2)
...
eigval_basic,nb_it_vals_basic = 
	...
	# dims[2] , innerLoopDim, tol_MGS, tol_conv,tol_bicgstab)
...
for loops = 1:10
	@threads for index = 1:length(restartDim_vals)
		...
		eigval_restart_vals[index], nb_it_vals_restart[index] = 
			jacDavRitzHarm_restart(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,
				P,alpha,innerLoopDim,restartDim_vals[index],dims,tol_MGS,tol_conv,tol_eigval,tol_bicgstab)
...
xlabel!("Restart size")
ylabel!("Number of iterations")
savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing restart size/restart_size_vs_nb_it.png")
...
# savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing restart size/restart_size_vs_relative_diff.png")



"""
If we want to test different operator sizes and see how the relative 
difference between the found eigenvalue and the theoretical one changes 
...
# ylabel!("Number of iterations")
# savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing operator size/operator_size_basic_vs_nb_it.png")
...
# xlabel!("Operator size")
# ylabel!("Number of iterations")
# savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing operator size/operator_size_restart_vs_nb_it.png")
...
# # xlabel!("Operator size")
# # ylabel!("Eigvals relative difference with Julia solve")
# # savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing operator size/operator_size_basic_vs_eigvals_relative_diff.png")
...
# # xlabel!("Operator size")
# # ylabel!("Eigvals relative difference with Julia solve")
# # savefig("/home/nic-molesky_lab/Github-Research-2023/Pade_Davidson_Added_P_matrices_greenVolumePlay_AnyNumberOfConstraints_NewSeanGFuncCode copy/Graphs/Changing operator size/operator_size_restart_vs_eigvals_relative_diff.png")
