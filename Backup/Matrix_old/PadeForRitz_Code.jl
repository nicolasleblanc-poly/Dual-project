...
function plot_surrogate_func(alpha_0,alpha_1,D,P1,max_val,s,ind)
    ...
    if ind == 1
        savefig("/home/nic-molesky_lab/Pad---Ritz-and-Harmonic-Ritz-duality-checker/Matrix/Graphs/zoomed1_in_graph_surr_func_vs_xi.png")
    elseif ind == 2
        savefig("/home/nic-molesky_lab/Pad---Ritz-and-Harmonic-Ritz-duality-checker/Matrix/Graphs/zoomed2_in_graph_surr_func_vs_xi.png")
    end
    ...
    savefig("/home/nic-molesky_lab/Pad---Ritz-and-Harmonic-Ritz-duality-checker/Matrix/Graphs/minimas_graph_surr_func_vs_xi.png")
...
function pade_stop_criteria(xl,x_start,big_x_sampled,big_y_sampled,errors)
    ...
    elseif length(big_x_sampled) > 1
        ...
        for i in range(1,length(pade_x1))
            print("pade_y1[i] ", pade_y1[i], "\n")
            print("pade_y2[i] ", pade_y2[i], "\n")
            error += abs(pade_y2[i] - pade_y1[i])/N
        end
        print("error in pade stop_crit ", error, "\n")
        push!(errors, error)
