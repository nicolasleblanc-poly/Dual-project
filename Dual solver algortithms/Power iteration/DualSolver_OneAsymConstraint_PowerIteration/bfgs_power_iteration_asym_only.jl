...
function power_iteration_first_evaluation(l,cellsA,gMemSlfN, gMemSlfA, chi_inv_coeff, P)
    ...
    while good == false
        ...
        A_bk = l[1]*asym_vect(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,b_k)
        ...
        # G|v> type calculation
        A_bk1 = l[1]*asym_vect(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,b_k1)
        ...
        # G|v> type calculation
        A_bk2 = l[1]*asym_vect(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff,P,b_k)
