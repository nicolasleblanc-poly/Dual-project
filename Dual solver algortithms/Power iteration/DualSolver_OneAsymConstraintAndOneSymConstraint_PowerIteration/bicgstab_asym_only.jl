...
function bicgstab(l, b, cellsA, gMemSlfN,gMemSlfA, chi_inv_coeff, P)
    ...
    for k in 1:length(b)
        ...
        vk = (l[1])*asym_vect(gMemSlfN,gMemSlfA, cellsA, chi_inv_coeff, P, pk)+l[2]*sym_vect(gMemSlfN,gMemSlfA,cellsA, chi_inv_coeff, P, pk)
        ...
        t = (l[1])*asym_vect(gMemSlfN,gMemSlfA, cellsA, chi_inv_coeff, P, s)+l[2]*sym_vect(gMemSlfN,gMemSlfA,cellsA, chi_inv_coeff, P, s)
