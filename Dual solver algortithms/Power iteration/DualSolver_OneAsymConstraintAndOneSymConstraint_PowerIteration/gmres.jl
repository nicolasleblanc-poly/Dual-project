...
function GMRES_with_restart(l, b, cellsA, gMemSlfN,gMemSlfA, chi_inv_coeff, P, m=20) # add cellsB for the BA case 
    ...
    for j in 1:m
        ...
        v = (l[1])*asym_vect(gMemSlfN,gMemSlfA, cellsA, chi_inv_coeff, P, Q[:,j])+l[2]*sym_vect(gMemSlfN,gMemSlfA,cellsA, chi_inv_coeff, P, Q[:,j])
        ...
        value = (l[1])*asym_vect(gMemSlfN,gMemSlfA, cellsA, chi_inv_coeff, P, x)+l[2]*sym_vect(gMemSlfN,gMemSlfA,cellsA,chi_inv_coeff, P, x)
